...
const Story = () => {
  ...
  return (
    <div>
      <TitleandSubtitels heading={`We love Stories`} subtitle={`pepole love us meny reson and they are share every moment with us`}></TitleandSubtitels>
    {storys.map((blog, index) => (
      ...
      >
        ...
        <div className="flex gap-2 items-center mt-4">
          ...
          <Link to="/allstory"><button className='btn btn-outline mt-4'>All Stories</button></Link>
        </div>
